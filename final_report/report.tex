...
We extracted top 2000 authors in ``Natural Language \& Speech'' area from Microsoft Academic Search [footfrint:http://academic.research.microsoft.com/RankList?entitytype=2&topDomainID=2&subDomainID=9], and use this extracted list as the authors' ranking. If author doesn't appear in the list, the rank will be zero.
...
All the content sentences within papers are parsed into phrase structure trees by using Stanford Parser [footfrint:http://nlp.stanford.edu/software/lex-parser.shtml]. The depth of tree is used as complexity of the corresponding sentence.  
...
There are three sub-components in the paper parser: Apache Tika [footprint:Apache Tika, http://tika.apache.org/], Metadata Extractor, and Title \& Author Extractor. 
